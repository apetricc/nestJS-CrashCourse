...
let SummaryService = class SummaryService {
    ...
    ;
    calculateSummary() {
        const totalExpense = this.reportService.getAllReports(data_1.ReportType.EXPENSE).
            reduce((sum, report) => sum + report.amount, 0);
        const totalIncome = this.reportService.getAllReports(data_1.ReportType.INCOME).
            reduce((sum, report) => sum + report.amount, 0);
        return {
            totalIncome,
            totalExpense,
